...
HD_PWD='C:/hlocal/multiplicadorparte2/multiplicadorparte2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult8b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult8b.tcl
