...
HD_PWD='C:/hlocal/multiplicadorparte2/multiplicadorparte2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mult8b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mult8b.tcl -notrace
