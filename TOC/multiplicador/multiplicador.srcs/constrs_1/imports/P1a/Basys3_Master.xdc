...
#set_property PACKAGE_PIN W5 [get_ports clk]							
	...
	create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4.1} 
	set_input_delay -clock [get_clocks {sys_clk_pin}] -min -add_delay 0 [get_ports {X[*]}]
    set_input_delay -clock [get_clocks {sys_clk_pin}] -max -add_delay 0 [get_ports {X[*]}]
    
    set_input_delay -clock [get_clocks {sys_clk_pin}] -min -add_delay 0 [get_ports {Y[*]}]
    set_input_delay -clock [get_clocks {sys_clk_pin}] -max -add_delay 0 [get_ports {Y[*]}]
    set_output_delay -clock [get_clocks {sys_clk_pin}] -min -add_delay 0[get_ports {Z[*]}]
    set_output_delay -clock [get_clocks {sys_clk_pin}] -max -add_delay 0 [get_ports {Z[*]}]
## Switches
